        ...
        <div  id="RegisterPage">
            <div className="row"  id="formreg1">
                ...
                <div id="formreg">
                    ...
                    <h1 id="regtext1">REGISTER</h1>

                   
                    <input type="text" className="form-control" name="Name" id="regtb1" placeholder="Name"
                    required/>
                    
                    <input type="email" className="form-control" name="Email" id="regtb1" placeholder="E-mail Address"
                    ...
                    <input type="password" className="form-control" name="password1" id="regtb1" placeholder="Password"
                        onChange={(e)=> setpassword(e.target.value)} required/>
                    
                    <div id="password_error" style={{ display: "none", color:"red", marginLeft:0,marginTop:-5 }}>please enter password</div><br />
                    
                    <input type="password" className="form-control" name="password2" id="regtb1" placeholder="Confirm Password"
                    ...
                    <a href onClick={e=>{register()}} ><div className="btn btn-info6" id="regtext2">Register</div></a>

                    <br></br><br></br>
               
                    <Link to="/" className="regLink" id="regtext4">Already Have an Account</Link>
                </div>
